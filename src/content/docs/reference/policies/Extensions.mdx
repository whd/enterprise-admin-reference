...
> We strongly recommend that you use the **[`ExtensionSettings`](/reference/policies/extensionsettings)** policy.
> It has the same functionality with additional configuration options.
> It does not support native paths, so you will have to use `file://` URLs.
